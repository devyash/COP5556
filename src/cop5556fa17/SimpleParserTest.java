...
//	
//	@Test
//	public void test_function() throws SyntaxException, LexicalException {
//		String input = "sin cos atan abs cart_x cart_y polar_a polar_r";
//		show(input);
//		Scanner scanner = new Scanner(input).scan();  
//		show(scanner);   
//		SimpleParser parser = new SimpleParser(scanner);  
...
//	
//	@Test
//	public void test_function_application() throws SyntaxException, LexicalException {
//		String input = "sin ( KW_x ) sin [ KW_x ]";
//		show(input);
//		Scanner scanner = new Scanner(input).scan();  
//		show(scanner);   
//		SimpleParser parser = new SimpleParser(scanner);  
